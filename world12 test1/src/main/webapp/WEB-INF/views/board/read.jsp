...
<body>
	...
	<div class="container">
		...
		<div id="replies" class="row">
			...
			<div class="panel panel-success">
			  ...
			  <div class="panel-heading">
			  		...
			  		<span class="pull-right">2020년07년07일...</span>
     ...
     <div class="row">
     <!--data-backdrop="static" 정상적인 조작을 해야 창이 없어짐  -->
...
/*  정적으로 만들어진 조상태그 이용*/
			...
			$(".modal-update-btn").click(function(arr){
		...
		function getList(bno){
			...
			$.getJSON("/replies/all/"+bno, function(data){
				...
				for(var i =0 ; i < data.length ; i++){
					...
					str +=  '<div class="panel panel-success"><div class="panel-heading"><span>rno: '+data[i]["rno"]+'</span>, <span>작성자: '+data[i]["replyer"]+'</span><span class="pull-right">'+data[i]["updatedate"]+'</span></div><div class="panel-body"><p>'+data[i]["replytext"]+'</p><button data-name="'+data[i]["replyer"]+'" data-rno="'+data[i]["rno"]+'" class="btn btn-warning btn-xs replymodify">수정</button><button data-name="'+data[i]["replyer"]+'" data-rno="'+data[i]["rno"]+'" class="btn btn-danger btn-xs replydelete">삭제</button></div></div>';
				}
